...
| 类                                                                                                                     | 说明                                                                                                                                                                               |
| ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [AST 节点](https://developers.google.com/blockly/reference/js/blockly.astnode_class.md)                                | AST 节点的类。建议您使用其中一个 createNode 方法，而不是直接创建节点。                                                                                                             |
| [基本光标](https://developers.google.com/blockly/reference/js/blockly.basiccursor_class.md)                            | 用于基本光标的类。这将使用户能够通过点击“下一页”或“上一页”转到 AST 中的所有节点。                                                                                                  |
| [块](https://developers.google.com/blockly/reference/js/blockly.block_class.md)                                      | 一个块的类。通常不直接调用，建议使用 workspace.newBlock()。                                                                                                                        |
...
| [禁播 Svg](https://developers.google.com/blockly/reference/js/blockly.blocksvg_class.md)                               | 用于块的 SVG 表示法的类。通常不直接调用，建议使用 workspace.newBlock()。                                                                                                           |
| [气泡](https://developers.google.com/blockly/reference/js/blockly.bubble_class.md)                                     | 用于界面气泡的类。                                                                                                                                                                 |
| [对话泡拖动器](https://developers.google.com/blockly/reference/js/blockly.bubbledragger_class.md)                      | 气泡拖动器的类。当用户通过鼠标或触摸操作拖动气泡时，系统会在画布上移动这些内容。包括块评论、更改器、警告或工作区评论。                                                           |
| [代码生成器](https://developers.google.com/blockly/reference/js/blockly.codegenerator_class.md)                        | 用于将代码块转换为语言的代码生成器类。                                                                                                                                             |
| [可折叠工具箱类别](https://developers.google.com/blockly/reference/js/blockly.collapsibletoolboxcategory_class.md)     | 工具箱中某个类别的类，可收起。                                                                                                                                                     |
| [备注](https://developers.google.com/blockly/reference/js/blockly.comment_class.md)                                    | 注释的类。                                                                                                                                                                         |
| [组件管理器](https://developers.google.com/blockly/reference/js/blockly.componentmanager_class.md)                     | 已向工作区注册的所有项的管理器。                                                                                                                                                   |
| [连接](https://developers.google.com/blockly/reference/js/blockly.connection_class.md)                                 | 用于块之间的连接的类。                                                                                                                                                             |
...
| [上下文菜单菜单](https://developers.google.com/blockly/reference/js/blockly.contextmenuregistry_class.md)              | 用于注册菜单项的类。此属性应是单例。您不应创建新实例，而应仅从 ContextMenuRegistry.registry 访问此类。                                                                             |
| [Cursor](https://developers.google.com/blockly/reference/js/blockly.cursor_class.md)                                   | 光标的类。光标用于控制用户如何进行 Blockly AST 导航。                                                                                                                              |
| [删除区域](https://developers.google.com/blockly/reference/js/blockly.deletearea_class.md)                             | 组件的抽象类，该类可以删除放置在上面的块或气泡。                                                                                                                                   |
| [拖动目标](https://developers.google.com/blockly/reference/js/blockly.dragtarget_class.md)                             | 一个组件的抽象类，当某个组件或气泡在组件上方或下方拖动时，具有自定义行为的组件。                                                                                                   |
| [字段](https://developers.google.com/blockly/reference/js/blockly.field_class.md)                                      | 可编辑字段的抽象类。                                                                                                                                                               |
...
| [字段下拉菜单](https://developers.google.com/blockly/reference/js/blockly.fielddropdown_class.md)                      | 用于可修改下拉菜单字段的类。                                                                                                                                                       |
...
| [手势](https://developers.google.com/blockly/reference/js/blockly.gesture_class.md)                                    | 用于一个手势的类。                                                                                                                                                                 |
| [网格](https://developers.google.com/blockly/reference/js/blockly.grid_class.md)                                       | 工作区网格的类。                                                                                                                                                                   |
| [水平飞行](https://developers.google.com/blockly/reference/js/blockly.horizontalflyout_class.md)                       | 一个飞出课程。                                                                                                                                                                     |
| [Icon](https://developers.google.com/blockly/reference/js/blockly.icon_class.md)                                       | 图标的类。                                                                                                                                                                         |
| [输入](https://developers.google.com/blockly/reference/js/blockly.input_class.md)                                      | 包含可选字段的输入的类。                                                                                                                                                           |
...
| [菜单](https://developers.google.com/blockly/reference/js/blockly.menu_class.md)                                       | 基本菜单类。                                                                                                                                                                       |
...
| [转变者](https://developers.google.com/blockly/reference/js/blockly.mutator_class.md)                                  | 转变器对话框的类。                                                                                                                                                                 |
| [名称](https://developers.google.com/blockly/reference/js/blockly.names_class.md)                                      | 实体名称数据库（变量、过程等）的类。                                                                                                                                               |
| [选项](https://developers.google.com/blockly/reference/js/blockly.options_class.md)                                    | 使用合理的默认设置解析用户指定的选项（行为未指定）。                                                                                                                               |
...
| [滚动条](https://developers.google.com/blockly/reference/js/blockly.scrollbar_class.md)                                | 用于纯 SVG 滚动条的类。此技术提供的滚动条保证能够正常运行，但其外观或行为可能不如系统的滚动条。                                                                                    |
...
| [主题](https://developers.google.com/blockly/reference/js/blockly.theme_class.md)                                      | 主题的类。                                                                                                                                                                         |
| [ThemeManager](https://developers.google.com/blockly/reference/js/blockly.thememanager_class.md)                       | 用于存储和更新工作区主题和界面组件的类。                                                                                                                                           |
| [工具箱](https://developers.google.com/blockly/reference/js/blockly.toolbox_class.md)                                  | 工具箱的类。创建工具箱的 DOM。                                                                                                                                                     |
| [工具箱类别](https://developers.google.com/blockly/reference/js/blockly.toolboxcategory_class.md)                      | 工具箱中的类别类。                                                                                                                                                                 |
...
| [回收站](https://developers.google.com/blockly/reference/js/blockly.trashcan_class.md)                                 | 垃圾桶类。                                                                                                                                                                         |
| [变量映射](https://developers.google.com/blockly/reference/js/blockly.variablemap_class.md)                            | 用于变量映射的类。其中包含一个字典数据结构，其中变量类型为键，变量列表为值。变量列表是由键指定的类型。                                                                             |
| [变量模型](https://developers.google.com/blockly/reference/js/blockly.variablemodel_class.md)                          | 变量模型的类。保存变量的信息，包括名称、ID 和类型。                                                                                                                                |
| [VerticalFlyout](https://developers.google.com/blockly/reference/js/blockly.verticalflyout_class.md)                   | 一个飞出课程。                                                                                                                                                                     |
| [警告](https://developers.google.com/blockly/reference/js/blockly.warning_class.md)                                    | 警告对应的类。                                                                                                                                                                     |
| [工作区](https://developers.google.com/blockly/reference/js/blockly.workspace_class.md)                                | 工作区类。这是一种包含数据块的数据结构。没有界面，可以无头创建。                                                                                                                   |
| [Workspace 音频](https://developers.google.com/blockly/reference/js/blockly.workspaceaudio_class.md)                   | 用于加载、存储和播放工作区音频的类。                                                                                                                                               |
| [Workspace 评论](https://developers.google.com/blockly/reference/js/blockly.workspacecomment_class.md)                 | 工作区注释的类。                                                                                                                                                                   |
...
| Enumeration                                                                                   | 说明                   |
| --------------------------------------------------------------------------------------------- | ---------------------- |
| [连接类型](https://developers.google.com/blockly/reference/js/blockly.connectiontype_enum.md) | 连接或输入类型的枚举。 |
| [输入类型](https://developers.google.com/blockly/reference/js/blockly.inputtypes_enum.md)     | 连接或输入类型的枚举。 |
...
| [粘贴](https://developers.google.com/blockly/reference/js/blockly.paste_1_function.md)                                                                                                                | 将代码块或工作区注释粘贴到主工作区。                                                                                                                               |
...
| 接口                                                                                                                           | 说明                                                                         |
| ------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------- |
| [Blockly 选项](https://developers.google.com/blockly/reference/js/blockly.blocklyoptions_interface.md)                         | 块选项。                                                                   |
| [IASTNode 位置](https://developers.google.com/blockly/reference/js/blockly.iastnodelocation_interface.md)                      | AST 节点位置接口。                                                           |
...
| [可删除](https://developers.google.com/blockly/reference/js/blockly.ideletable_interface.md)                                   | 可以删除的对象接口。                                                         |
| [IDeleteArea](https://developers.google.com/blockly/reference/js/blockly.ideletearea_interface.md)                             | 组件的接口，可删除置于其上的块或气泡。                                       |
| [可拖动](https://developers.google.com/blockly/reference/js/blockly.idraggable_interface.md)                                   | 可拖动对象的接口。                                                           |
...
| [改进](https://developers.google.com/blockly/reference/js/blockly.imovable_interface.md)                                       | 可移动对象的接口。                                                           |
| [可定位](https://developers.google.com/blockly/reference/js/blockly.ipositionable_interface.md)                                | 位于工作区上方的组件的接口。                                                 |
| [可注册](https://developers.google.com/blockly/reference/js/blockly.iregistrable_interface.md)                                 | 可注册的 Blockly 组件的接口。                                                |
| [ISelectable](https://developers.google.com/blockly/reference/js/blockly.iselectable_interface.md)                             | 可选对象的接口。                                                             |
...
| 命名空间                                                                                                                 | 说明 |
| ------------------------------------------------------------------------------------------------------------------------ | ---- |
| [AST 节点](https://developers.google.com/blockly/reference/js/blockly.astnode_namespace.md)                              |      |
| [块](https://developers.google.com/blockly/reference/js/blockly.block_namespace.md)                                    |      |
...
| [剪贴板](https://developers.google.com/blockly/reference/js/blockly.clipboard_namespace.md)                              |      |
| [可折叠工具箱类别](https://developers.google.com/blockly/reference/js/blockly.collapsibletoolboxcategory_namespace.md)   |      |
| [common](https://developers.google.com/blockly/reference/js/blockly.common_namespace.md)                                 |      |
| [组件管理器](https://developers.google.com/blockly/reference/js/blockly.componentmanager_namespace.md)                   |      |
| [常量](https://developers.google.com/blockly/reference/js/blockly.constants_namespace.md)                                |      |
| [上下文菜单](https://developers.google.com/blockly/reference/js/blockly.contextmenu_namespace.md)                        |      |
| [ContextMenuItems](https://developers.google.com/blockly/reference/js/blockly.contextmenuitems_namespace.md)             |      |
| [上下文菜单菜单](https://developers.google.com/blockly/reference/js/blockly.contextmenuregistry_namespace.md)            |      |
| [CSS](https://developers.google.com/blockly/reference/js/blockly.css_namespace.md)                                       |      |
| [对话框](https://developers.google.com/blockly/reference/js/blockly.dialog_namespace.md)                                 |      |
| [活动](https://developers.google.com/blockly/reference/js/blockly.events_namespace.md)                                   |      |
| [扩展功能](https://developers.google.com/blockly/reference/js/blockly.extensions_namespace.md)                           |      |
...
| [输入](https://developers.google.com/blockly/reference/js/blockly.input_namespace.md)                                    |      |
...
| [极简主义](https://developers.google.com/blockly/reference/js/blockly.minimalist_namespace.md)                           |      |
| [名称](https://developers.google.com/blockly/reference/js/blockly.names_namespace.md)                                    |      |
| [选项](https://developers.google.com/blockly/reference/js/blockly.options_namespace.md)                                  |      |
| [流程](https://developers.google.com/blockly/reference/js/blockly.procedures_namespace.md)                               |      |
| [域名注册管理机构](https://developers.google.com/blockly/reference/js/blockly.registry_namespace.md)                     |      |
| [RenderedConnection](https://developers.google.com/blockly/reference/js/blockly.renderedconnection_namespace.md)         |      |
| [序列化](https://developers.google.com/blockly/reference/js/blockly.serialization_namespace.md)                          |      |
...
| [主题](https://developers.google.com/blockly/reference/js/blockly.theme_namespace.md)                                    |      |
| [ThemeManager](https://developers.google.com/blockly/reference/js/blockly.thememanager_namespace.md)                     |      |
| [主题](https://developers.google.com/blockly/reference/js/blockly.themes_namespace.md)                                   |      |
| [thrasos](https://developers.google.com/blockly/reference/js/blockly.thrasos_namespace.md)                               |      |
| [工具箱类别](https://developers.google.com/blockly/reference/js/blockly.toolboxcategory_namespace.md)                    |      |
| [ToolboxSeparator](https://developers.google.com/blockly/reference/js/blockly.toolboxseparator_namespace.md)             |      |
| [提示](https://developers.google.com/blockly/reference/js/blockly.tooltip_namespace.md)                                  |      |
| [轻触](https://developers.google.com/blockly/reference/js/blockly.touch_namespace.md)                                    |      |
| [uiPosition](https://developers.google.com/blockly/reference/js/blockly.uiposition_namespace.md)                         |      |
| [实用程序](https://developers.google.com/blockly/reference/js/blockly.utils_namespace.md)                                |      |
| [变量](https://developers.google.com/blockly/reference/js/blockly.variables_namespace.md)                                |      |
| [变量动态](https://developers.google.com/blockly/reference/js/blockly.variablesdynamic_namespace.md)                     |      |
...
| [块设置](https://developers.google.com/blockly/reference/js/blockly.blocks_variable.md)                                     | 块类型名称与块原型对象的映射。                                                                            |
...
| [配置](https://developers.google.com/blockly/reference/js/blockly.config_variable.md)                                         | 此对象用于保存开发者希望能够更改 Blockly 上的所有值。                                                     |
...
| [已选择](https://developers.google.com/blockly/reference/js/blockly.getselected_variable.md)                                  | 返回当前选定的可复制对象。                                                                                |
| [输入值](https://developers.google.com/blockly/reference/js/blockly.input_value_variable.md)                                  |                                                                                                           |
...
| [](https://developers.google.com/blockly/reference/js/blockly.output_value_variable.md)OUTPUT_VALUE                           |                                                                                                           |
| [上一个状态](https://developers.google.com/blockly/reference/js/blockly.previous_statement_variable.md)                       |                                                                                                           |
...
| [setLocale](https://developers.google.com/blockly/reference/js/blockly.setlocale_variable.md)                                 |

将语言区域（即本地化的消息/block-text/等）设置为给定的语言区域。
...
| [版本](https://developers.google.com/blockly/reference/js/blockly.version_variable.md) | Blockly 核心版本。此常量会被 build 脚本（npm run build）替换到 package.json 中的版本值。此操作由 build 压缩的 gulp 任务中的 Closure Compiler 完成。对于本地构建，您可以将 --define='Blockly.VERSION=X.Y.Z' 传递给编译器以替换此常量。 |
...
| [菜单生成器](https://developers.google.com/blockly/reference/js/blockly.menugenerator_typealias.md)                                  | 可以是菜单选项数组，也可以是用于为 FieldDropdown 或其后代生成菜单选项数组的函数。      |
...
| [菜单选项](https://developers.google.com/blockly/reference/js/blockly.menuoption_typealias.md)                                       | 下拉菜单中的单个选项。第一个元素是人类可读的值（文本或图片），第二个元素是语言中性值。 |
